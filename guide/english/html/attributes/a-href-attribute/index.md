...
It's also possible to set an anchor to a certain place on the page. To do this you should first place a tab at the location on the page with tag <a> and necessary the attribute "name" with any keyword description in it, like this:
